...
final_table = pd.concat([data, y_preds_df], axis = 1)
...
def home():
    return render_template('index.html',  tables=[final_table.to_html(classes='data')], titles=final_table.columns.values)
